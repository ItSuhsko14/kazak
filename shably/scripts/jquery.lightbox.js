...
{	// Create our Plugin function, with $ as the argument (we pass the jQuery object over later)
	...
	{	// Our LightboxClass definition
		...
		files: {
			...
			css: {
				lightbox:	'scripts/jquery.lightbox.css'
			},
			images: {
				prev:		'scripts/lightbox_img/prev.gif',
				next:		'scripts/lightbox_img/next.gif',
				blank:		'scripts/lightbox_img/blank.gif',
				loading:	'scripts/lightbox_img/loading.gif'
			}
		},
